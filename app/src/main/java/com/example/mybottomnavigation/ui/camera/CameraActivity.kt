...
import com.example.mybottomnavigation.databinding.ActivityCameraBinding
import com.example.mybottomnavigation.ui.upload.UploadActivity
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        val photoFile = com.example.mybottomnavigation.createFile(application)
